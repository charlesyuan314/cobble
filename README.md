...
This repository contains a research prototype implementation of the Cobble language from the paper ["Cobble: Compiling Block Encodings for Quantum Computational Linear Algebra"](https://arxiv.org/abs/2511.01736). This code is provided as-is to aid in reproducibility.
